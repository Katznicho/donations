<div class="bg-white-200 py-4 px-6 flex mb-20 items-center justify-between tab-text hidden" id="tab3Text">
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between">
        ...
        <div class="flex-1 flex">
            ...
            <img src="{{ asset('images/swisnl/filament-backgrounds/curated-by-swis/child.jpg') }}" alt="Banner Image" class="h-1/4 w-full object-cover">
        </div>
