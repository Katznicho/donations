...
@section('content')
    ...
    <div class="border rounded-lg p-4 mb-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="first_name" name="first_name" class="rounded-md border border-gray-300 p-2 w-full">
            </div>
            <div>
                <label for="last_name" class="block text-gray-700 font-medium mb-2">Last Name</label>
                <input type="text" id="last_name" name="last_name" class="rounded-md border border-gray-300 p-2 w-full">
            </div>
        </div>
        <div class="mt-4">
        ...
        <div class ="mt-4">
            ...
            <input type="text" id="contact_number" name="contact_number" class="rounded-md border border-gray-300 p-2 w-full">
        </div>
        ...
        <div class="mt-4">
            <label for="billing_address" class="inline-flex items-center cursor-pointer">
                <input type="checkbox" id="billing_address" name="billing_address" class="rounded-full bg-gray-200 border-gray-300 focus:outline-none focus-ring w-4 h-4 checked:bg-blue-500 focus:ring-blue-600">
    ...
    <div class="flex justify-center">
        <button type="submit" class="bg-blue-500 text-white px-6 py-3 rounded-md">Proceed to Payment</button>
    </div>
</form>
